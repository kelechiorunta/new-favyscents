import React, {useContext, memo, startTransition, useEffect, useState } from 'react';
...
export default memo(function ShoppingCart() {
  ...
  const {updatedItems, handleUpdateItems, result, deleteItem} = useContext(productContext)//useProducts(); 
          ...
          <ViewChild id={'cart-section'}>
            <div style={{textAlign: 'center'}} className="child-cart-section">
              ...
              <div className="cart-child-container">
                  <CartSection items={updatedItems} handleUpdateItems={handleUpdateItems} result={result} deleteItem={deleteItem} updateProducts={updateProducts}/>
                  <OrderSection totalPrice={totalP} handleUpdateItems={handleUpdateItems} deleteItem={deleteItem} updateProducts={updateProducts}/>
              </div>
            </div>
          </ViewChild>
        </ViewProvider>
