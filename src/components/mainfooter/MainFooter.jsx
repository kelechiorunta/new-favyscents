    ...
    <div className="main-footer">
      ...
      <div className="copyright-section">
        ...
        <p className="trademark">
          FavyScents is an independent retailer carrying genuine brand name
          Perfumes, skincare, haircare, candles and makeup. FavyScents and
          FavyScents are trademarks of FavyScents, Inc. and are Registered in
          the Nigerian Patent & Trademark Office.
        </p>
