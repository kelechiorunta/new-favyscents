...
export default function ShippingForm({ref, handleAction, pending}) {
  return (
            <form ref={ref} onSubmit={handleAction} style={{display: 'flex', flexDirection: 'column', gap: '1rem'}}>
                    ...
                    </div>                        <div style={{display: 'flex', gap: '1rem', width: '600px', alignItems: 'center', justifyContent: 'space-between'}}>
