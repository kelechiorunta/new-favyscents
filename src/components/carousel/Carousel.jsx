...
export const Item = ({ id, name, pic, supplier, price, quantity }) => {
  ...
  const { handleUpdateItems, handleUpdate, isSuccess, message, newQuantity } =
    ...
    <>
      ...
      >
        ...
        <div className="collection-details">
          {isSuccess ? <Toaster message={message} /> : null}
    ...
    try {
      if (selectedItems) {
        const selectedItem = selectedItems.find(
          (allitem) => allitem.name === item.name
        )
        if (selectedItem) {
